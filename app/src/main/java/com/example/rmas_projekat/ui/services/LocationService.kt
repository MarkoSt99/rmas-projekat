...
class LocationService : Service() {
    ...
    private val notifiedObjects = mutableSetOf<String>() // Track notified objects
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        notifiedObjects.clear() // Clear notifications on restart
    ...
    private fun sendLocationToServer(location: Location) {
        ...
        checkForNearbyObjects(location) // Check for objects nearby
    }
                ...
                for (document in documents) {
                    ...
                    if (geoPoint != null) {
                        ...
                        if (distance <= 200 && !notifiedObjects.contains(objectId)) {
                            isNearby = true
                            notifiedObjects.add(objectId) // Mark this object as notified
